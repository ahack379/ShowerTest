#ifndef LARLITE_BACKGROUNDCCNC_CXX
#define LARLITE_BACKGROUNDCCNC_CXX

#include "BackgroundCCNC.h"
...
namespace larlite {
  ...
  bool BackgroundCCNC::initialize() {    
  ...
  bool BackgroundCCNC::analyze(storage_manager* storage) {
    ...
    _mu_len = ev_tagged_trk->at(0).Length(0); // CCNCulates the length from point 0 to end
