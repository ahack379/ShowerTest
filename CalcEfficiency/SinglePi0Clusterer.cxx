#ifndef LARLITE_SinglePI0CLUSTERER_CXX
#define LARLITE_SinglePI0CLUSTERER_CXX

#include "SinglePi0Clusterer.h"
...
namespace larlite {
  ...
  SinglePi0Clusterer::SinglePi0Clusterer() {
    _name="SinglePi0Clusterer";
    _fout=0;
  ...
  bool SinglePi0Clusterer::initialize() {

    return true;
  }
  
  bool SinglePi0Clusterer::analyze(storage_manager* storage) {
  ...
  bool SinglePi0Clusterer::finalize() {
