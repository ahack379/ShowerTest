/**
 * \file TruthMatchShowerRecoEff.h
 *
 * \ingroup HitDensity
 * 
 * \brief Class def header for a class TruthMatchShowerRecoEff
 *
 * @author ah673
 */
...
#ifndef LARLITE_TRUTHMATCHSHOWERRECOEFF_H
#define LARLITE_TRUTHMATCHSHOWERRECOEFF_H
...
namespace larlite {
  /**
     \class TruthMatchShowerRecoEff
     User custom analysis class made by SHELL_USER_NAME
   */
  class TruthMatchShowerRecoEff : public ana_base{
  
  public:

    /// Default constructor
    TruthMatchShowerRecoEff(){ _name="TruthMatchShowerRecoEff"; _fout=0; _tree=0; }

    /// Default destructor
    virtual ~TruthMatchShowerRecoEff(){}

    /** IMPLEMENT in TruthMatchShowerRecoEff.cc!
