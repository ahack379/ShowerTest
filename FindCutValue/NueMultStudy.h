 ...
 * 
 * \brief Class def header for a class NueMultStudy
 *
...
#ifndef LARLITE_NUEMULTSTUDY_H
#define LARLITE_NUEMULTSTUDY_H
...
namespace larlite {
   ...
   */
  class NueMultStudy : public ana_base{
  
  public:

    /// Default constructor
    NueMultStudy(){ _name="NueMultStudy"; _fout=0; _tree=nullptr; _ratio_cut = 0.; _radius = 40. ;}

    /// Default destructor
    virtual ~NueMultStudy(){}
