 ...
 * \ingroup Filters
 * 
 * \brief Class def header for a class GREnergyRes
 *
 * @author ah673
 */
...
namespace larlite {
   ...
   */
  class GREnergyRes : public ana_base{
  
  public:

    /// Default constructor
    GREnergyRes(){ _name="GREnergyRes"; _fout=0; _gamma_tree=0; _tree=0; _one_gamma_tree = 0; _compare_tree = 0; }

    /// Default destructor
    virtual ~GREnergyRes(){}

    /** IMPLEMENT in GREnergyRes.cc!
